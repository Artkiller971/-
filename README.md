...
- **React, Express/Fastify, Objectionjs, TypeORM, Redux, RTK Query**
- **HTML, CSS, Material UI, Vite, Pug**
- **Автоматическое тестирование (Jest)**
- **Git, GitBash, WSL, Linux**
...
## Опыт работы
### МЭИ НИЛ РТС (01.09.2025)

Занимался разработкой клиентской части SPA приложений. Основной стек: React, Redux Toolkit, Material UI.

Интегрировал систему потокового вещания с камер на базе LiveKit.\
Спроектировал и реализовал интерактивный конструктор сценариев с использованием React Flow.Реализовал drag-and-drop интерфейс, кастомные узлы.

Настраивал обмен данными с сервером через WebSocket для мгновенного обновления статусов устройств и событий в системе без перезагрузки страницы.

---

## О себе

Fullstack разработчик. Стремлюсь развиваться в направлении web разработки.\
