...
Спроектировал и реализовал интерактивный конструктор сценариев с использованием React Flow.\n
Реализовал drag-and-drop интерфейс, кастомные узлы.\n
Настроил обмен данными с сервером через WebSocket для мгновенного обновления статусов устройств и событий в системе без перезагрузки страницы.\n
---
